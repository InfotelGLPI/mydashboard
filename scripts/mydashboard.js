...
var mydashboard = {
    ...
    setOriginalDashboard : function(dash){ this.dashboard = dash;},
    setLanguageData : function(languageData){ this.language = languageData; },
    setRootDoc : function(root){ this.rootDoc = root; },
    ...
    handleResponse : function(request)  {
            request.done(function( msg ) {
                ...
                setTimeout(function(){$('.plugin_mydashboard_header_info').html(mydashboard.oldmsg); },500);
    ...
    automaticRefreshAll : function(delay)  {
            setInterval(function(){ mydashboard.refreshAll(); }, delay);
        },
    ...
    prepareDataForAjax : function(classname, widgetindex, view) {
        ...
        if(typeof view != "undefined") {
            dataForAjax = { dashboard_plugin_classname : classname, dashboard_plugin_widget_index : widgetindex, dashboard_plugin_widget_view : view  };
    ...
    //        WidgetData =  eval('('+json.data+')');  
        ...
        try {
            ...
            setTimeout(function(){scriptsFunction();},1);
        } catch(e) {
...
$(document).ready(function()
{
    ...
    var menu = false;
    $('.plugin_mydashboard_add_button,.plugin_mydashboard_menuDashboard').click( function(e){ menu = true; });
    $(document).click( function() { if(!menu) { $('.plugin_mydashboard_menuDashboard').hide(); } else { menu = false } });
