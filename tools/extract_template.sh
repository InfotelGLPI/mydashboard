...
xgettext *.php */*.php --copyright-holder='MyDashboard Development Team' --package-name='GLPI - MyDashboard plugin' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
