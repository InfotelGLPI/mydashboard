...
xgettext *.php */*.php --copyright-holder='MyDashboard Development Team' --package-name='GLPI - MyDashboard plugin' --package-version='1.6.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
