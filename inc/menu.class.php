...
//                        );";
     ...
     * @global type $PLUGIN_HOOKS, that's where you have to declare your classes that defines widgets, in $PLUGIN_HOOKS['mydashboard'][YourPluginName]
