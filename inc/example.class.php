      ...
      switch ($widgetId) {
         ...
         case "PluginMydashboardExamplewidget2" : //widget2 is a Vertical Bar Chart
            ...
            if ($advanced) {
               ...
               $widget2->setTabDatas([["x" => 0, "y" => 4, "z" => 1, "v" => 0, "w" => 4], ["x" => 3, "y" => 1, "z" => 6, "v" => 1.5, "w" => 2]]);
               $widget2->setOption("xaxis", ["ticks" => PluginMydashboardBarChart::getTicksFromLabels($widget2->getTabDatas())]);
               ...
               $widget2->setOption('spreadsheet', ["show" => true]);
            }
         ...
         case "PluginMydashboardExamplewidget3" :
            ...
            if ($advanced) {
               ...
               $widget3->setTabDatas(["Un" => 0, "Deux" => 4, "Trois" => 1, "Cinq" => 4]);
               ...
               $widget3->setOption("yaxis", ["ticks" => PluginMydashboardBarChart::getTicksFromLabels($widget3->getTabDatas())]);
               ...
               $widget3->setOption("markers", ["show" => true, "position" => "lm", "labelFormatter" => PluginMydashboardBarChart::getLabelFormatter(1)]);
            }
         ...
         case "PluginMydashboardExamplewidget4" : //widget4 is a Pie Chart
            ...
            if ($advanced) {
               ...
               //Value = X units
               $widget4->setOption('pie', ['labelFormatter' => PluginMydashboardPieChart::getLabelFormatter(2, __("Value", 'mydashboard') . " = ", " " . __("units", 'mydashboard'))]);
            }
            return $widget4;
            break;
         case "PluginMydashboardExamplewidget5" : //widget5 is a Line Chart
            ...
            $widget5->setTabDatas(["f(x)" => $sampleDatas]);
            return $widget5;
            break;
         case "PluginMydashboardExamplewidget6" : //widget6 is a Datatable
            ...
            $widget6->setTabNames(["x", "y"]);
            $widget6->setTabDatas([[1, 0], ["y" => 2, "x" => 4], [3, 1], [5, 4]]);
         ...
         case "PluginMydashboardExamplewidget7" : //The seventh widget is a widget that displays the hour, it's to test/show the automatic refreshing of widgets
            ...
            $widget7->setTabDatas([__("Minutes elapsed", 'mydashboard') => date('i'), __("Minutes left", 'mydashboard') => 60 - date('i')]);
            ...
            $widget7->setOption('pie', ['fillOpacity' => '1', 'startAngle' => '0.75', 'labelFormatter' => PluginMydashboardPieChart::getLabelFormatter(3)]);
         ...
         case "PluginMydashboardExamplewidget8" :
            ...
            $widget8->setTabDatas([
                  "real " => [1 => 2, 2 => 4, 3 => 1, 4 => 1, 5 => 4],
                  "expected " => [1 => 2, 2 => 2, 3 => 2, 4 => 2, 5 => 2]
               ]
            );
            $widget8->setOption("mouse", ["track" => true]);
            return $widget8;
            break;
