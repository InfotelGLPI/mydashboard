...
class PluginMydashboardExample extends CommonGLPI {
    ...
    function getWidgetContentForItem($widgetId) {
        ...
        switch ($widgetId) {
            case "PluginMydashboardExamplewidget1" : return $this->getWidgetHtml($widgetId);
                break;
...
//                    $widget2->setWidgetId("PluginMydashboardExample"."widget2");
                    ...
                    return $widget2;
                break;
            case "PluginMydashboardExamplewidget3" : $widget3 = new PluginMydashboardHBarChart() ; //On déclare un widget (H(orizontal)BarChart)
