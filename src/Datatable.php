...
class Datatable extends Module
{
     ...
     * @return array
     */
    public function getTabNamesHidden()
    {
     ...
     */
    public function setTabNames($_tabNames)
    {
     ...
     */
    public function setTabNamesHidden($_tabNamesHidden)
    {
     ...
     * @param  $optionValue , the value of the option (can be a php array)
     * @param bool $force
     * @return bool
     */
