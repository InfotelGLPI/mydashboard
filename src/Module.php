 ...
 */
abstract class Module extends CommonGLPI
{
    private $widgetId;
    ...
    public function getWidgetId()
    {
        if (!isset($this->widgetId)) {
            if ($_SESSION['glpi_use_mode'] == Session::DEBUG_MODE) {
                Toolbox::logDebug("Module::getWidgetId() You probably want to get a widgetId, but this one is not set, by default its value is 'iddefault'");
            }
    ...
    public function getWidgetTitle()
    {
        if (!isset($this->widgetTitle)) {
            if ($_SESSION['glpi_use_mode'] == Session::DEBUG_MODE) {
                Toolbox::logDebug("Module::getWidgetTitle() You probably want to get a widgetTitle, but this one is not set, by default its value is 'Default Title'");
            }
    ...
    {
        $this->widgetScripts = array_merge(Helper::extractScriptsFromString($_html), $this->widgetScripts);

        $this->widgetHtmlContent = Helper::removeScriptsFromString($_html);
    }
    ...
    {
        $this->widgetScripts = array_merge(Helper::extractScriptsFromString($_html), $this->widgetScripts);
        $this->widgetHtmlContent = $this->widgetHtmlContent . Helper::removeScriptsFromString($_html);
    }
