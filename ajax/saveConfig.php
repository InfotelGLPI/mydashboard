...
//      } else {
//         //If an error occured
//         finish(true, __("Can't add this widget in Database", "mydashboard"));
//      }
//   }
...
//      finish(false, "(" . __("Added", "mydashboard")/*." : '".$widgetName."'"*/ . ")");
//   } else {
//      finish(true, __("Can't add this widget on users Dashboard", "mydashboard"));
//   }
//} else {
//   //Deletion case
...
//
//         finish(false, "(" . __("Deleted", "mydashboard")/*." : '".$widgetName."'"*/ . ")");
//      }
//   } else {
//      //Updating order case
...
//         }
//         if ($result) {
//            finish(false, "(" . __("Updated", "mydashboard") . ")");
//         } else {
//            finish(true, __("Can't save new order", "mydashboard"));
//         }
//      } else { //any other case
...
// * @param string $msg
// */
//function finish($error = false, $msg = "")
//{
